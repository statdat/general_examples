# General 
Scripts showing general bioinformatic pipelines and analyses.

## example_AssignTaxonomy
Runs through the multilocus sequence alignment pipeline. GyrB, RpoB, and RpoD is searched against a type strain reference database and the best hit is used to assign taxonomy. Please ask for data (8 gb!)
